    ...
    if ($result) {
        ...
        if ($row) {
            ...
            if ($password === $db_password) {
                ...
                echo "<center><div class='form'><h2 style ='color:red'>Incorrect Username/password.</h2></div></center>";
            }
        } else {
            echo "<center><div class='form'><h2 style ='color:red'>Incorrect Username/password.</h2></div></center>";
        }
    ...
    <div class="con">
        ...
        <div>
            <form method = "POST">
                ...
                <p style = "text-align: center;">Login as admin <a href="dormpayloginadmin.php" style ="text-decoration: none;">click here</a></p>
        ...
        <div>
            ...
            <br>
            <p style = "text-align: left;">You don't have an account? <a href="dormypayRegistration.php" style ="text-decoration: none;">click here</a></p>
        </div>
